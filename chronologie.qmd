...
- Un formulaire en ligne type [Google Forms®](https://www.google.fr/intl/fr/forms/about/) ou [LymeSurvey®](https://www.limesurvey.org/fr) par ex.). C'est simple, rapide, gratuit mais attention à la sécurité : Google Form® est conforme au RGDP mais n'est pas conforme  à la loi HIPAA donc ne devrai pas être utilisé pour des données de santé. Si les données sont complètement anonymisés ça peut passer (Un homme né le 12/03/47 pesant 76 Kg & hospitalisé du 12 au 17/03/23 en Médecine B ce n'est pas anonyme, on peut retrouver de qui il s'agit).
