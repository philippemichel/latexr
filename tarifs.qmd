...
Je ne facture pas à l'heure car si je vais très vite pour certaines tâches c'est que j'ai passé beaucoup de temps à me former mais aussi à rédiger mes macros & mes scripts, temps que je ne vous facture pas directement mais que dois prendre en compte.<br> Voir l'[histoire du coup de marteau](https://www.map-consult.com/fr/savoir-faire/le-coup-de-marteau.html).
